  ...
  <div class="py-6">
    ...
    <div class="grid grid-cols-2 gap-4 mt-6">
      <div
        ...
        :key="i"
        class="relative bg-custom-gray rounded-xl h-48 overflow-hidden"
      >
        <img
        ...
        />
        <div
          class="absolute text-white text-sm p-2 bottom-0 left-0 w-full bg-black-custom rounded-bl-xl rounded-br-xl overflow-hidden"
        >
          {{ player.name }}
        </div>
      </div>
